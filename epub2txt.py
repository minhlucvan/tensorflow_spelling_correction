...
if __name__ == "__main__":
    ...
    for book in book_files:
      try:
        converter = epub2txt(os.path.join(path + book))
        print(converter.epub)
        converter.convert()
      except:
